	...
	public static void counterProcess()
	{
		...
		for (int j = 0; j <= total/4; j++) 
		{
						...
						
					{
								...
								if ( counter2>counter3 && counter2>counter4 && counter2%2==0 )
								{
								...
								else if( counter3>counter2 && counter3>counter4 && counter3%2==0 )
								{
								...
								else if( counter4>counter2 && counter4>counter3 && counter4%2==0)
								{
